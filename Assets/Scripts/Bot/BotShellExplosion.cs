...
public class BotShellExplosion : MonoBehaviour {
    ...
    private float CalculateDamage(Vector3 targetPosition)
    {
        ...
        float reletiveDistance = (m_ExplosionRadius - explosionDistance) / m_ExplosionRadius;
        float damage = reletiveDistance * m_MaxDamage;
